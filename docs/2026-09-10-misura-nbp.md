...
```
costo(n)  = 127 + round(n × 0,5)      millesimi
...
La base è 127 e non 126 perché i token di «pensiero» ballano di ±2 millesimi
fra una chiamata e l'altra: meglio stimare un millesimo sopra che trovarsi
sotto. **Non si sottostima mai**, e il margine resta dentro la banda che la
home dichiara.
...
- `src/engine/listino.js`: costo **127 + 0,5 × riferimenti**, non 123 fisso;
  `resa: 'jpeg'`, non `png`;
