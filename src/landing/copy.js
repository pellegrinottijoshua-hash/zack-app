...
export const COPY = {
  it: {
    ...
    tool: {
      ...
      remove: 'Togli questo file',
      resizing: 'Zack sta cambiando la misura…',
      righello: 'Righello',
      ...
      model: 'Con quale modello',
      modelFast: 'Rapido',
      modelQuality: 'Qualità',
      modelNeedsGpu: 'Questo browser non regge il modello grande.',
  ...
  en: {
    ...
    tool: {
      ...
      resizing: 'Zack is changing the size…',
      righello: 'Ruler',
      ripristina: 'Restore',
      cancella: 'Erase',
      ...
      modelNeedsGpu: 'This browser cannot run the large model.',
